...
extern json_spirit::Value bitsend(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value bitmessage(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value bitdisable(const json_spirit::Array& params, bool fHelp);
